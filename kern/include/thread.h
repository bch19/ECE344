...
struct thread {
	...
	struct array *childpid_array;


	/* Thread's exiting status */
	int exit_status;
	int exit_code;

	/* Thread's cv for waitpid & exit */
	struct semaphore *waitpid_sem;
